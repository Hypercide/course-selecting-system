...
<head>
    ...
    <script src="/public/js/background/three.min.js" type="text/javascript"></script>
</head>
<body>

<div class="login-main">
    <header class="layui-elip">选课系统登录</header>
    <form class="layui-form" method="post" id="loginform">
        <div class="layui-input-inline">
            <input type="text" name="s_id" id="s_id" required lay-verify="required" placeholder="用户名" autocomplete="off" class="layui-input">
        </div>
        <div class="layui-input-inline">
        ...
        <p><a href="<?php echo site_url("Login/reg") ?>" class="fl">立即注册</a><a href="javascript:;" class="fr">忘记密码？</a></p>
    </form>
</div>
<script src="/public/js/background/wallbgcanvas.js" type="text/javascript"></script>
        ...
        form.on('submit(check)', function(data){
            ...
            $.ajax({
                ...
                success: function(msg){
                    ...
                    if (msg.digit==1)
                    {
                        window.location.href="<?php echo site_url("Homepage/studentindex") ?>";
                    }else if (msg.digit==2) {
