...
<head>
	...
	<script type="text/javascript" src="/public/js/student_index.js"></script>
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					<li class="layui-nav-item" id="userInfo">
						...
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="<?php echo site_url("User/userdata") ?>"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="<?php echo site_url("User/changepwd") ?>"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="<?php echo site_url("Homepage/studentmainview") ?>"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<?php echo site_url("Homepage/studentmainview") ?>"></iframe>
					</div>
				</div>
			</div>
		</div>
