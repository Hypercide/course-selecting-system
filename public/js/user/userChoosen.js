layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#courseList',
        url : 'http://course.cn/User/getchoosen',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limit : 12,
        ...
        cols : [[
            ...
            {field: 'course_id', title: '课程号', width:80, align:"center"},
            ...
            {field: 'course_testtype', title: '考核方式', width:100,align:'center'},
    ...
    table.on('tool(courseList)', function(obj){
        ...
        if(layEvent === 'del'){          //选择课程
            layer.confirm('确定要退出此课程？',{icon:3, title:'提示信息'},function(index){
